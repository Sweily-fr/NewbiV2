        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {isEditing
              ...
              : "Créez un nouveau champ pour vos fiches produits"}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">
                Le champ devra être rempli pour chaque produit
              </p>
            </div>
            <Switch
...
export default function ProductCustomFieldsManager({ open, onOpenChange }) {
  const { workspaceId } = useWorkspace();
  const { fields, loading, refetch } = useProductCustomFields(workspaceId);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] flex flex-col">
        <DialogHeader>
          <DialogTitle>Champs personnalisés produits</DialogTitle>
          <DialogDescription>
            Gérez les champs personnalisés de vos fiches produits
          </DialogDescription>
        </DialogHeader>
