...
export default function CompanySection({ register, errors, watch, setValue, session }) {
  ...
  const profileImage = previewUrl || watch("logo") || "https://github.com/shadcn.png";
      ...
      <Card>
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-4">
            <Avatar className="h-20 w-20 cursor-pointer" onClick={handleThumbnailClick}>
