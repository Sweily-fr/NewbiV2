      ...
      <Card>
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="bankDetails.iban" className="flex items-center gap-2">
          ...
          {/* BIC */}
          <div className="space-y-2">
            <Label htmlFor="bankDetails.bic" className="flex items-center gap-2">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                  ...
                  Elles ne seront utilisées que pour les virements et facturations.
                </p>
              </div>
            </div>
          </div>
