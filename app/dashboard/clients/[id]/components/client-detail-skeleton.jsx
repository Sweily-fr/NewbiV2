...
// Skeleton de la page détail client (header compact + onglets + contenu à
// gauche + sidebar détails à droite). Partagé entre loading.jsx, le fallback
// du ProRouteGuard et les états de chargement internes de la page pour que
// la transition loading.jsx -> guard -> page -> données soit invisible.
