...
// Grille de cartes skeleton des segments. Partagée entre le loading.jsx,
// le fallback du ProRouteGuard et l'état de chargement interne de la page
// pour que la transition soit invisible.
export function SegmentsGridSkeleton() {
  return (
...
// Skeleton de la page complète (header titre + sous-titre + bouton, grille
// de cartes). Reprend la même structure que la page réelle.
