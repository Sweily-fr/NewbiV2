                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            ...
                            >
                              ...
                              <SelectContent>
                                <SelectItem value="art-293b-cgi">TVA non applicable, art. 293 B du CGI</SelectItem>
                                <SelectItem value="franchise-base">Franchise en base de TVA, art. 293 B du CGI</SelectItem>
                                <SelectItem value="auto-entrepreneur">Auto-entrepreneur - TVA non applicable, art. 293 B du CGI</SelectItem>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-2">
                          ...
                          <Label className="text-sm font-medium">Remise sur cet article</Label>
                        </div>
                            ...
                            <div className="space-y-1">
                              <Input
                                ...
                                {...register(`items.${index}.discount`, { 
                                  ...
                                  max: watch(`items.${index}.discountType`) === 'percentage' ? {
                                    value: 100,
