...
export default function QuotePreview({ data = {}, className = "", status }) {
  ...
  const taxAmount =
    ...
    discountAmount * 0.2; // Approximation de la TVA sur la remise
        ...
        <div className="flex justify-between items-start mb-8">
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ fontSize: "10px", color: "#666" }}>
              ...
              <p style={{ margin: "2px 0" }}>
                Date d'émission:{" "}
                {formatDate(data.issueDate) || formatDate(new Date())}
              </p>
              <p style={{ margin: "2px 0" }}>
                Date de validité:{" "}
            ...
            <div style={{ fontSize: "10px", color: "#666", lineHeight: "1.3" }}>
              ...
              {typeof data.companyInfo?.address === "string" ? (
                <p style={{ whiteSpace: "pre-line" }}>
                  {" "}
                  {data.companyInfo.address || "Non renseignée"}
                </p>
              ) : (
                <>
                  ...
                  <p>
                    {data.companyInfo?.address?.postalCode ||
                      ...
                      "Non renseigné"}{" "}
                    {data.companyInfo?.address?.city || "Non renseignée"},{" "}
                    {data.companyInfo?.address?.country || "Non renseigné"}
                  </p>
                </>
              )}
          ...
          <div>
            ...
            data.client.shippingAddress ? (
              <>
                ...
                <div
                  style={{ fontSize: "10px", color: "#666", lineHeight: "1.3" }}
                >
                  <p>
                    <strong>
                      {data.client.name ||
                  ...
                  {data.client.shippingAddress.street && (
                    <p>{data.client.shippingAddress.street}</p>
                  )}
                  ...
                  {data.client.shippingAddress.country && (
                    <p>{data.client.shippingAddress.country}</p>
                  )}
                </div>
              </>
            ) : (
              ...
              {data.customFields &&
                ...
                data.customFields.map((field, index) => {
                  return (
                    ...
                    >
                      <span>
                        {field.label || field.name || `Champ ${index + 1}`}
                      </span>
