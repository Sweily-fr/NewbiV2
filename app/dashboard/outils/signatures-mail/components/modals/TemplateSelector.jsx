...
// Template 4: Photo ronde à gauche avec icônes sociales en dessous, nom + poste (couleur) + téléphone à droite, logo + site web en bas à droite
const TemplatePreview4 = () => (
  <div className="p-3">
    <div className="flex items-start gap-3">
      {/* Avatar + icônes sociales */}
      <div className="flex flex-col items-center flex-shrink-0">
        <img
          src="/uifaces-popular-avatar.jpg"
          alt="Avatar"
      ...
      <div className="flex-1 min-w-0 text-left">
        ...
        <div className="flex items-center text-left gap-2">
          ...
          />
          {/* Barre verticale */}
          <div className="w-px h-2 bg-gray-300 dark:bg-gray-600 flex-shrink-0" />
          <p className="text-[8px] text-gray-500 truncate">www.letsignit.com</p>
        </div>
      </div>
    </div>
  ...
  <div className="p-3">
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[8px] truncate" style={{ color: PRIMARY_COLOR }}>
          Representative
        </p>
        <p className="text-[8px] text-gray-500 truncate">T. 8006427676</p>
      </div>
    ...
    <div className="flex items-center justify-between mt-2 pt-2 border-t border-gray-200 dark:border-gray-700">
      <img src="/newbiLetter.png" alt="Logo" className="h-4 object-contain" />
      <p className="text-[8px] text-gray-500">www.letsignit.com</p>
      <SocialIcons size={2.5} />
    </div>
  </div>
);
...
const TemplatePreview6 = () => (
  <div className="p-3 text-center">
    ...
    <p className="text-[8px] text-gray-500 truncate">Representative</p>
    <p className="text-[8px] text-gray-500 truncate">T. 8006427676</p>
    <p className="text-[8px] text-gray-500 truncate">www.letsignit.com</p>
  ...
  <div className="p-3">
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[8px] text-gray-500 truncate">Representative</p>
        <p className="text-[8px] text-gray-500 truncate">M. 425-882-1032</p>
        <p className="text-[8px] text-gray-500 truncate">T. 8006427676</p>
      </div>
    </div>
    <div className="flex items-center justify-between mt-2">
      <p className="text-[7px] text-gray-400 truncate">
        admin@KM366s113234.OnMicrosoft.com • www.letsignit.com
      </p>
      <SocialIcons size={2.5} />
    </div>
  </div>
...
const TEMPLATE_PRESETS = {
  ...
  template4: {
    ...
    horizontalLayout: {
      leftColumn: ["photo", "social"],
      rightColumn: ["fullName", "position", "contact", "logo", "website"],
      bottomRow: [],
    },
    typography: {
      fullName: { fontSize: 14, color: "#171717", fontWeight: "bold" },
  ...
  template6: {
    ...
    elementsOrder: ["logo", "fullName", "position", "contact", "social"],
    typography: {
      fullName: { fontSize: 14, color: PRIMARY_COLOR, fontWeight: "bold" },
      position: { fontSize: 12, color: PRIMARY_COLOR, fontWeight: "normal" },
      phone: { fontSize: 11, color: "#666666" },
      website: { fontSize: 11, color: "#666666" },
    },
  ...
  template7: {
    ...
    horizontalLayout: {
      leftColumn: ["photo"],
      rightColumn: ["fullName", "position", "contact"],
      bottomRow: ["email", "website", "social"],
    },
    typography: {
      fullName: { fontSize: 14, color: PRIMARY_COLOR, fontWeight: "bold" },
      position: { fontSize: 12, color: PRIMARY_COLOR, fontWeight: "normal" },
      phone: { fontSize: 11, color: "#666666" },
      mobile: { fontSize: 11, color: "#666666" },
      website: { fontSize: 11, color: "#666666" },
    },
    socialNetworks: {
      facebook: { url: "#" },
...
const TEMPLATES = [
  ...
  },
  {
    id: "template6",
    name: "Centré",
    preview: TemplatePreview6,
  },
  {
    id: "template7",
    name: "Détaillé",
    preview: TemplatePreview7,
  },
  {
    id: "template8",
    name: "Professionnel",
    preview: TemplatePreview8,
  },
];
