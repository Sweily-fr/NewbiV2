...
// Skeleton partagé de l'éditeur de bon de livraison.
// Reprend la structure réelle de ModernDeliveryNoteEditor (overlay plein
...
export function DeliveryNoteEditorSkeleton() {
  return (
