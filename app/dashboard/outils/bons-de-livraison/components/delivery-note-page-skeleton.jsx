...
// Skeleton du tableau des bons de livraison (toolbar + tableau).
// Mêmes dimensions que l'état de chargement de DeliveryNoteTable pour que la
// transition finale vers les données soit invisible.
export function DeliveryNoteTableSkeleton() {
  return (
...
export function DeliveryNotePageSkeleton() {
  return (
    <>
      {/* Desktop */}
