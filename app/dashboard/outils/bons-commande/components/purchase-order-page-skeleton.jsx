...
// Skeleton du tableau des bons de commande (toolbar + tableau).
// Mêmes dimensions que l'état de chargement de PurchaseOrderTable pour que la
// transition finale vers les données soit invisible.
export function PurchaseOrderTableSkeleton() {
  return (
...
export function PurchaseOrderPageSkeleton() {
  return (
    <>
      {/* Desktop */}
