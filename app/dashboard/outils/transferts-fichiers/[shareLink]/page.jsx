...
import { GET_TRANSFER_BY_LINK, GENERATE_FILE_TRANSFER_PAYMENT_LINK } from '../graphql/mutations';
...
export default function TransferPage() {
  ...
  const demoTransfer = {
    ...
    files: [
      ...
      { name: 'presentation.pptx', size: 5242880, url: '/demo/presentation.pptx' }
    ],
    ...
    maxDownloads: 10,
    downloadCount: 3,
    customMessage: 'Voici les fichiers que vous avez demandés. Merci de votre confiance !',
      ...
      <div className="min-h-screen flex items-center justify-center p-6">
        <Card className="w-full max-w-md">
          <CardContent className="p-6 text-center">
            <IconAlertCircle className="mx-auto mb-4 text-destructive" size={48} />
            <h2 className="text-xl font-semibold mb-2">Transfert introuvable</h2>
            <p className="text-muted-foreground mb-4">
              Ce lien de transfert n'existe pas ou a expiré.
            </p>
            <p className="text-sm text-muted-foreground">
              Vérifiez que vous avez utilisé le bon lien ou contactez l'expéditeur.
            </p>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 p-6">
      <div className="w-full">
        ...
        <p className="text-muted-foreground text-sm">
          {transferData.files.length} fichier{transferData.files.length > 1 ? 's' : ''} • {formatFileSize(getTotalSize())}
        </p>
      </div>
        ...
        {transferData.customMessage && (
          <Card>
            <CardContent className="p-6">
              <p className="text-sm leading-relaxed">{transferData.customMessage}</p>
            </CardContent>
          </Card>
        )}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {new Date(transferData.expiryDate).toLocaleDateString('fr-FR', {
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric'
                    })}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    ...
                    {transferData.maxDownloads && ` / ${transferData.maxDownloads}`}
                  </p>
                </div>
              </div>
          ...
          <Card className="border-orange-200 bg-orange-50">
            <CardContent className="p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-orange-800">Paiement requis</h3>
                  <p className="text-sm text-orange-700">
                    Un paiement de {transferData.paymentAmount}€ est requis pour accéder aux fichiers.
                  </p>
                </div>
              </div>
              <Button 
              ...
              >
                {paymentLoading ? 'Génération...' : `Payer ${transferData.paymentAmount}€`}
              </Button>
            </CardContent>
          </Card>
        )}
          ...
          <Card className="border-red-200 bg-red-50">
            <CardContent className="p-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-red-800">Transfert expiré</h3>
                  <p className="text-sm text-red-700">
                    Ce transfert a expiré le {new Date(transferData.expiryDate).toLocaleDateString('fr-FR')}.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-orange-200 bg-orange-50">
            <CardContent className="p-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-orange-800">Limite de téléchargements atteinte</h3>
                  <p className="text-sm text-orange-700">
                    Ce transfert a atteint sa limite de {transferData.maxDownloads} téléchargements.
                  </p>
                </div>
              </div>
            </CardContent>
