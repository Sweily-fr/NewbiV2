...
// Skeleton partagé de la page liste kanban : rendu par loading.jsx, par le
// loadingComponent du RoleRouteGuard et par l'état de chargement de la page,
// pour que la transition entre les étapes de chargement soit invisible.

export function KanbanTableSkeleton() {
  return (
...
export function KanbanListPageSkeleton() {
  return (
