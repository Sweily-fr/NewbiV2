...
import { useBoard, useCreateColumn, useCreateTask, useMoveTask, useTaskDragAndDrop } from '@/src/hooks/useKanban';
      ...
      await createTask({
        variables: {
          input: {
            ...
            columnId,
            status: 'TODO',
            position: board?.tasks?.filter(t => t.columnId === columnId).length || 0,
          },
        },
      });
  ...
  if (error) {
    return (
      <div className="container mx-auto p-6">
        ...
        <Button onClick={() => router.push('/dashboard/outils/kanban')} className="mt-4">
          Retour aux tableaux
        </Button>
      </div>
    );
        ...
        <header className="bg-white border-b border-gray-200">
          <div className="px-6 py-4 flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">Tableau Kanban</h1>
                <p className="text-sm text-gray-500">Gérez vos tâches efficacement</p>
              </div>
            </div>
