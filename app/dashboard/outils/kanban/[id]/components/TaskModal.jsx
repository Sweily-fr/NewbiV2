...
import { LoaderCircle, Trash2, X, CalendarIcon, Clock, FileText, MessageSquare, ChevronDown, Flag, Users, UserPlus, Columns, Tag, Send, Edit2, Paperclip, Bold, Italic, Underline, List, ListOrdered, Quote, Code, Link, Building2, Search } from 'lucide-react';
...
function TaskClientSelector({ clientId, clientName, onChange }) {
  ...
  if (clientId && clientName) {
    return (
      <div className="flex items-center gap-2">
        <Badge variant="outline" className="inline-flex items-center gap-1.5 py-1 px-2.5 text-xs font-medium rounded-md">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <TaskClientSelector
                  ...
                  onChange={(clientId, client) => setTaskForm({ ...taskForm, clientId, client })}
                />
              </div>
            </div>
