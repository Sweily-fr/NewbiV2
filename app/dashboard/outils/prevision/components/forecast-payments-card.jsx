...
// Libellés : même source que les pages Transactions et Factures d'achat.
const INCOME_CATEGORIES = [
  ...
  {
    key: "OTHER_INCOME",
    label: getCategoryLabel("OTHER_INCOME"),
    bg: "bg-emerald-100",
  ...
  },
  {
    ...
    label: getCategoryLabel("REFUNDS_RECEIVED"),
    bg: "bg-amber-100",
    text: "text-amber-600",
    icon: PiggyBank,
  },
...
const EXPENSE_CATEGORIES = [
  ...
  {
    key: "SALARIES",
    label: getCategoryLabel("SALARIES"),
    bg: "bg-blue-100",
    text: "text-blue-600",
    icon: Users,
  },
  {
    key: "SUBSCRIPTIONS",
    label: getCategoryLabel("SUBSCRIPTIONS"),
    bg: "bg-violet-100",
  ...
  {
    key: "SERVICES",
    label: getCategoryLabel("SERVICES"),
    bg: "bg-cyan-100",
    text: "text-cyan-600",
    icon: Wrench,
  },
  {
    key: "SOFTWARE",
    label: getCategoryLabel("SOFTWARE"),
    bg: "bg-indigo-100",
  ...
  {
    key: "TRANSPORT",
    label: getCategoryLabel("TRANSPORT"),
    bg: "bg-emerald-100",
  ...
  {
    key: "INSURANCE",
    label: getCategoryLabel("INSURANCE"),
    bg: "bg-sky-100",
    text: "text-sky-600",
    icon: Shield,
  },
  ...
  },
  {
    ...
    label: getCategoryLabel("TELECOMMUNICATIONS"),
    bg: "bg-teal-100",
    text: "text-teal-600",
    icon: Phone,
  },
  ...
  {
    key: "OFFICE_SUPPLIES",
    label: getCategoryLabel("OFFICE_SUPPLIES"),
    bg: "bg-gray-100",
    text: "text-gray-500",
    icon: Package,
  },
  {
    key: "HARDWARE",
    label: getCategoryLabel("HARDWARE"),
    bg: "bg-slate-100",
    text: "text-slate-500",
    icon: Cpu,
  },
  {
    key: "TRAINING",
    label: getCategoryLabel("TRAINING"),
    bg: "bg-lime-100",
    text: "text-lime-600",
    icon: GraduationCap,
  },
  {
    key: "MAINTENANCE",
    label: getCategoryLabel("MAINTENANCE"),
    bg: "bg-stone-100",
    text: "text-stone-500",
    icon: HardDrive,
  },
  {
    key: "UTILITIES",
    label: getCategoryLabel("UTILITIES"),
    bg: "bg-neutral-100",
  ...
  {
    key: "OTHER_EXPENSE",
    label: getCategoryLabel("OTHER_EXPENSE"),
    bg: "bg-gray-100",
    text: "text-gray-400",
    icon: MoreHorizontal,
  },
