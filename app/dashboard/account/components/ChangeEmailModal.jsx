...
export function ChangeEmailModal({ isOpen, onClose, currentEmail }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Changement d'email vers:", newEmail);
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Saisissez votre nouvelle adresse e-mail. Un email de confirmation sera envoyé.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <Label htmlFor="confirm-email">Confirmer la nouvelle adresse e-mail</Label>
            <Input
              id="confirm-email"
              type="email"
              value={confirmEmail}
