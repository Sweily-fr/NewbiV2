...
/**
 * Quote PDF Preview Generator Page
 *
 * Unlike /pdf-generator/quote/[id] which fetches from DB (auth required),
 * this page reads quote data from window.__PREVIEW_DATA injected by the
 * caller (Puppeteer via evaluateOnNewDocument, or the mobile WebView).
 *
 * Mirror of /pdf-generator/invoice/preview but type="quote".
 */
export default function QuotePDFPreviewPage() {
  ...
  useEffect(() => {
    async function init() {
      try {
        // Read data injected by the caller
