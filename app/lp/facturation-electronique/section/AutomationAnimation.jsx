...
// Carte « Ce que Newbi fait à ta place » — une facture (icône trait fin)
// à gauche, une ligne qui passe par deux étapes et arrive sur un check vert :
// le trajet se fait tout seul. Monochrome, un seul accent.
  ...
  return (
    ...
    >
      ...
      <div className="auto-caption opacity-0 mt-6 flex items-center gap-2 text-[11px] text-neutral-500">
        ...
        <span>Statut</span>
        <span className="text-neutral-300">→</span>
        <span className="font-medium text-neutral-900">Archivée</span>
      </div>
    </div>
  );
}
