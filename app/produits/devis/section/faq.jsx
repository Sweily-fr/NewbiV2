  ...
  return (
    <div className=\\"mx-auto w-full max-w-3xl space-y-7 px-4 pt-16 pb-16\\">
      <div className=\\"space-y-2 text-center\\">
        <h2 className=\\"text-3xl md:text-4xl tracking-tight font-normal\\">Questions fréquentes</h2>
        <p className=\\"text-muted-foreground max-w-2xl mx-auto\\">
          Nous sommes là pour répondre à toutes vos questions. Si vous ne trouvez
          pas l'information recherchée, n'hésitez pas à nous contacter.
        </p>
      </div>
      <Accordion
        type=\\"single\\"
      ...
      <p className=\\"text-muted-foreground\\">
        ...
        <a href=\\"mailto:contact@newbi.fr\\" className=\\"text-primary hover:underline\\">
          équipe support
        </a>
      </p>
    </div>
