                          ...
                          <div className="flex-1 relative">
                            ...
                            >
                              ...
                              <path
                                ...
                                style={{
                                  animation:
                                    "areaFade 1s ease-out 0.8s forwards",
                                }}
                              />
                              <path
                                ...
                                style={{
                                  animation:
                                    "drawLine 1.2s ease-out 0.3s forwards",
                                }}
                              />
                            </svg>
                          </div>
                          ...
                          <div className="flex-1 relative -mx-4 -mb-4 flex">
                            ...
                            >
                              ...
                              <path
                                ...
                                style={{
                                  animation:
                                    "areaFade 0.8s ease-out 1.2s forwards",
                                }}
                              />
                              <path
                                ...
                                style={{
                                  animation:
                                    "drawLineIncome 1s ease-out 0.8s forwards",
                                }}
                              />
                            </svg>
                          </div>
                          ...
                          <div className="flex-1 relative -mx-4 -mb-4 flex">
                            ...
                            >
                              ...
                              <path
                                ...
                                style={{
                                  animation:
                                    "areaFade 0.8s ease-out 1.4s forwards",
                                }}
                              />
                              <path
                                ...
                                style={{
                                  animation:
                                    "drawLineIncome 1s ease-out 1s forwards",
                                }}
                              />
                            </svg>
                          </div>
