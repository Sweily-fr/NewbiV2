...
const testimonials = [
  {
    id: 1,
    quote:
      "Le suivi de trésorerie en temps réel a transformé ma gestion financière. Je vois enfin clairement où va mon argent et je peux anticiper mes besoins.",
    name: "Sophie Martin",
    role: "Gérante",
  ...
  },
  {
    id: 2,
    quote:
      "Les prévisions de cash flow m'ont permis d'éviter plusieurs découverts. Un outil indispensable pour tout entrepreneur.",
    name: "Thomas Dubois",
    role: "Fondateur",
    company: "StartupDigital",
    image: "/lp/testimonials/avatar2.jpg",
  },
  {
    id: 3,
    quote:
      "La synchronisation bancaire automatique me fait gagner des heures chaque semaine. Plus besoin de saisir manuellement mes opérations.",
    name: "Marie Leroy",
    role: "Directrice financière",
    company: "AgenceConseil",
