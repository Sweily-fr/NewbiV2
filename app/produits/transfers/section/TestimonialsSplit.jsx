...
const testimonials = [
  {
    id: 1,
    quote:
      "Le transfert de fichiers avec newbi est devenu indispensable pour mon agence. Fini les emails qui bloquent, je partage mes maquettes et vidéos en un clic. Mes clients adorent la simplicité.",
  ...
  },
  {
    id: 2,
    quote:
      "Sécurisé, rapide et illimité. Exactement ce dont j'avais besoin pour partager mes fichiers CAO avec mes clients et partenaires.",
    name: "Julie Moreau",
    role: "Architecte",
    company: "Moreau Architecture",
    image: "/lp/testimonials/avatar2.jpg",
  },
  {
    id: 3,
    quote:
      "Les liens protégés par mot de passe et la traçabilité des téléchargements me permettent de partager mes documents confidentiels en toute sérénité.",
    name: "David Laurent",
    role: "Avocat",
