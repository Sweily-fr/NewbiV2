...
const MiniUploadAnimation = dynamic(() => import("./MiniUploadAnimation"), {
  ssr: false,
});
const ShareTrackingAnimation = dynamic(
  () => import("./ShareTrackingAnimation"),
  { ssr: false },
);
      ...
      <div className="max-w-6xl px-4 mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-md font-normal tracking-tight text-gray-600 mx-auto mb-8 max-w-2xl">
            Du partage au téléchargement, Newbi sécurise et simplifie chaque
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 border-y border-neutral-200 divide-neutral-200">
          ...
          <div className="border-b border-neutral-200 flex flex-col">
            <div className="p-4 md:p-8">
              ...
              <p className="text-neutral-600 mt-2 max-w-md text-balance">
                Chiffrement SSL/TLS, protection par mot de passe et liens à
                durée limitée pour garder le contrôle sur vos fichiers.
              </p>
            </div>
                ...
                <div className="flex items-center gap-4 px-5 py-4 rounded-2xl bg-[#F8F9FA]">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[9px] font-semibold text-[#22C55E] bg-[#22C55E]/8 px-2.5 py-1 rounded-full">
                        Actif
                      </span>
                    </div>
                    <p className="text-[11px] text-neutral-400 mt-0.5">
                      Protocole HTTPS · Données chiffrées en transit
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 px-5 py-4 rounded-2xl bg-[#F8F9FA]">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[9px] font-semibold text-[#F59E0B] bg-[#F59E0B]/8 px-2.5 py-1 rounded-full">
                        Optionnel
                      </span>
                    </div>
                    <p className="text-[11px] text-neutral-400 mt-0.5">
                      Accès restreint aux destinataires autorisés
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 px-5 py-4 rounded-2xl bg-[#F8F9FA]">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[9px] font-semibold text-[#3B82F6] bg-[#3B82F6]/8 px-2.5 py-1 rounded-full">
                        7 jours
                      </span>
                    </div>
                    <p className="text-[11px] text-neutral-400 mt-0.5">
          ...
          <div className="border-b md:border-b-0 md:border-r border-neutral-200">
            <div className="p-4 md:p-8">
              ...
              <p className="text-neutral-600 mt-2 max-w-md text-balance">
                Notifications en temps réel et tableau de bord complet pour
                savoir exactement qui a téléchargé vos fichiers et quand.
              </p>
            </div>
                  ...
                  {[
                    {
                      ...
                      color: "#5A50FF",
                      bg: true,
                      title: "Lien créé et partagé",
                      desc: "3 fichiers · 5.98 Go · Expire dans 7j",
                      time: "14:20",
                    },
                    {
                      icon: "eye",
                    ...
                    },
                    {
                      ...
                      color: "#22C55E",
                      bg: true,
                      title: "Julie a téléchargé",
                      desc: "Maquette_Final.psd · 1.8 Go",
                      time: "14:33",
                      avatar:
                        "https://randomuser.me/api/portraits/women/44.jpg",
                    },
                    {
                      ...
                      color: "#22C55E",
                      bg: true,
                      title: "Thomas a téléchargé",
                      desc: "Rushes_Campagne.mov · 3.2 Go",
                      time: "15:10",
