            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                <h1 className="mt-8 max-w-8xl mx-auto text-balance font-semibold text-6xl md:text-7xl lg:mt-16 xl:text-[3.5rem]">
                  Obtenez des{" "}
                  <span className="bg-gradient-to-r from-[#38bdf8] to-[#7dd3fc] px-2 py-1 text-white rounded-md inline-block transform -rotate-1">
                    signatures
                  </span>
                  <br />
                  instantanées
                ...
                <p className="mx-auto mt-8 max-w-2xl text-balance text-md">
                  Obtenez des signatures instantanées pour vos documents. Créez,
                  envoyez et gérez vos signatures en quelques clics avec notre
                  solution intuitive.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    asChild
                    size="lg"
                    className="rounded-xl px-5 text-base bg-[#38bdf8]"
                  >
                    <Link href="/dashboard/outils/signatures">
                      <span className="text-nowrap">Créez votre signature</span>
                    </Link>
                  </Button>
                </div>
              </div>
            ...
            <div className="mx-auto max-w-6xl px-6 lg:px-12">
              <div className="flex flex-col items-center justify-center">
                <p className="text-md font-medium text-gray-600 mb-6">
                  +1.000 entreprises utilisent newbi pour gérer leurs signatures
                </p>
                <LogoMarquee
                  logos={[
