            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="space-y-4 lg:space-y-6 text-center lg:text-left">
                ...
                <p className="text-gray-400 text-xs pt-3 text-center lg:text-left">
                  Plusieurs entreprises nous font déjà confiance · Compatible
                  ...
                  <div className="absolute bottom-8 -left-16 z-50 bg-white rounded-2xl shadow-lg border border-neutral-100 p-5 w-[280px] hidden lg:block">
                    <div className="flex gap-4">
                      <div className="flex flex-col items-center gap-2 shrink-0">
                        ...
                        <div className="flex gap-1">
                          {[
                            ...
                            <div
                              key={i}
                              className="w-5 h-5 rounded-md bg-[#f0eeff] flex items-center justify-center"
                            >
                              <svg width="9" height="9" viewBox="0 0 24 24">
                                <path d={d} fill="#5A50FF" />
                              </svg>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] font-semibold text-[#5A50FF]">
                          Co-fondateur &amp; CEO
                        </p>
                        <p className="text-[9px] text-neutral-400 mt-0.5">
                          Newbi · Facturation intelligente
                        </p>
