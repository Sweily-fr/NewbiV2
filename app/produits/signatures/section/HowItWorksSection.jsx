      ...
      <div className="max-w-6xl px-4 mx-auto">
        ...
        <div className="text-center mb-10 md:mb-14">
          ...
          <p className="text-md font-normal tracking-tight text-gray-600 mx-auto max-w-2xl">
            Créer une signature professionnelle n&apos;a jamais été aussi
            simple.
          </p>
        </div>
          ...
          <div className="bg-[#F8F9FA] rounded-3xl p-8 flex flex-col justify-between lg:min-h-[650px] relative lg:overflow-hidden">
            <div>
              ...
              <p className="text-base text-gray-600 max-w-md mb-6">
                ...
                correspond le mieux à votre identité.
              </p>
              <Link
                href="/auth/register"
              ...
              <div className="grid grid-cols-2 gap-3 p-4">
                ...
                <div className="bg-white rounded-xl border border-neutral-100 p-4 shadow-sm">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-[#E8E5FF] flex items-center justify-center text-[#5A50FF] text-xs font-bold">
                      SM
                    </div>
                    <div>
                      ...
                      <p className="text-[8px] text-neutral-300 mt-0.5">
                        sophie@startup.com · +33 6 12 34
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl border border-neutral-100 p-4 shadow-sm">
                  ...
                  <div className="flex flex-col items-center text-center">
                    <div className="w-8 h-8 rounded-full bg-[#FFE0CC] flex items-center justify-center text-[#E8723A] text-[10px] font-bold -mt-5 border-2 border-white">
                      TD
                    </div>
                    <p className="text-[10px] font-semibold text-neutral-800 mt-1.5">
                      Thomas Dubois
                    </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-[#F8F9FA] rounded-3xl p-8 flex-1 flex flex-col justify-between lg:overflow-hidden relative">
              <div>
                ...
                <p className="text-sm text-gray-600 max-w-sm">
                  Ajoutez votre logo, photo, coordonnées et réseaux sociaux.
              ...
              <div className="relative mt-4 -mx-4 lg:mt-0 lg:mx-0 lg:absolute lg:bottom-0 lg:right-0 lg:w-[75%] lg:translate-x-[15%] lg:translate-y-[25%]">
                <div className="bg-white rounded-2xl shadow-lg border border-neutral-100 overflow-hidden">
                  <div className="px-5 py-3 border-b border-neutral-50 flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-[#5A50FF] font-medium">
                      Aperçu →
                    </span>
                  </div>
                  <div className="p-5 space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2.5">
                        {[
                          ...
                          <div
                            key={i}
                            className={`w-5 h-5 rounded-full cursor-pointer ${i === 0 ? "ring-[1.5px] ring-offset-2 ring-[#8B7FFF]" : ""}`}
                    ...
                    <div className="space-y-2">
                      <div className="h-8 rounded-lg bg-neutral-50 border border-neutral-100 flex items-center px-3 gap-2">
                        <span className="text-[9px] text-neutral-300 w-12 shrink-0">
                          Nom
                        </span>
            ...
            <div className="bg-[#F8F9FA] rounded-3xl p-8 flex-1 flex flex-col justify-between lg:overflow-hidden relative">
              <div>
                ...
                <p className="text-sm text-gray-600 max-w-sm">
                  Copiez votre signature en un clic et collez-la dans Gmail,
                  Outlook ou tout autre client email.
                </p>
              </div>
              {/* Mini copy UI */}
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1 h-11 rounded-xl bg-neutral-50 border border-neutral-100 flex items-center justify-center gap-2">
                        <img
                          src="https://cdn.brandfetch.io/id5o3EIREg/theme/dark/symbol.svg?c=1bxid64Mup7aczewSAYMX&t=1696475443284"
                          alt="Gmail"
                      ...
                      <div className="flex-1 h-11 rounded-xl bg-neutral-50 border border-neutral-100 flex items-center justify-center gap-2">
                        <img
                          src="https://cdn.brandfetch.io/idgdw68PEO/w/900/h/842/theme/dark/logo.jpeg?c=1bxid64Mup7aczewSAYMX&t=1667605535117"
                          alt="Outlook"
