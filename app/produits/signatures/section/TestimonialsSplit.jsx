...
const testimonials = [
  {
    id: 1,
    quote:
      "Grâce à newbi, toute notre équipe commerciale a maintenant des signatures uniformes et professionnelles. L'installation a pris 5 minutes et le résultat est impeccable.",
  ...
  },
  {
    id: 2,
    quote:
      "Les bannières promotionnelles dans nos signatures ont généré 30% de clics en plus vers notre site. Un outil marketing sous-estimé !",
    name: "Pierre Martin",
  ...
  },
  {
    id: 3,
    quote:
      "Simple, efficace et professionnel. Mes clients remarquent toujours ma signature et ça renforce ma crédibilité en tant que consultant.",
    name: "Marie Lefevre",
