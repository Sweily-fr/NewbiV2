...
export async function GET(request, { params }) {
  try {
    ...
    console.log('Fichiers disponibles:', data.data.getFileTransferByLink.fileTransfer.files);
    ...
    console.log('Impossible de générer le lien - storageType:', file.storageType, 'r2Key:', file.r2Key);
    return NextResponse.json(
