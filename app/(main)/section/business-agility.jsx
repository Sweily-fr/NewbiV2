          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
            ...
            >
              <div className="relative h-60 shrink-0">
                <div className="h-60 bg-[url('/images/lp-home/Collaborateur.jpg')] bg-[length:100%] bg-no-repeat"></div>
            ...
            >
              <div className="relative h-60 shrink-0">
                <div className="relative h-60 shrink-0">
                  <div className="h-60 bg-[url('/images/lp-home/Vitesse_superieur.jpg')] bg-[length:100%] bg-no-repeat"></div>
                  <div className="absolute inset-0 bg-linear-to-b from-white to-50% group-data-dark:from-gray-800 group-data-dark:from-[-25%]"></div>
                </div>
              </div>
              <div className="relative p-6">
            ...
            >
              <div className="relative h-60 shrink-0">
                <div className="h-60 bg-[url('/images/lp-home/Ecosysteme.jpg')] bg-[length:100%] bg-no-repeat"></div>
                <div className="absolute inset-0 bg-linear-to-b from-white to-50% group-data-dark:from-gray-800 group-data-dark:from-[-25%]"></div>
              </div>
              <div className="relative p-6">
                <h3
            ...
            >
              <div className="relative h-60 shrink-0">
                <div className="h-60 bg-[url('/images/lp-home/Reglement.jpg')] bg-[length:100%] bg-no-repeat"></div>
                <div className="absolute inset-0 bg-linear-to-b from-white to-50% group-data-dark:from-gray-800 group-data-dark:from-[-25%]"></div>
              </div>
              <div className="relative p-6">
                <h3
