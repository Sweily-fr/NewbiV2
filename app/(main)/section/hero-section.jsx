  ...
  return (
    <>
      <main className="overflow-hidden">
        <section className="h-[100vh] md:h-[98vh] flex flex-col justify-between bg-gradient-to-t from-[#fce8e6] via-[#f8f9fc] to-[#f0f4ff] rounded-[15px] md:rounded-[18px] lg:rounded-[18px] shadow-xs mx-2 mt-2">
