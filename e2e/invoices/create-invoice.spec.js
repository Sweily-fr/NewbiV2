...
test.describe("Factures", () => {
  ...
  test("Flow: Création facture standard complète (2 étapes)", async ({
    authenticatedPage: page,
  }) => {
    ...
    await expect(page.locator("text=Type de facture")).toBeVisible({
      timeout: 5000,
    });
    const typeSelect = page.locator("#invoice-type").first();
    await typeSelect.click();
    await expect(
      page.locator('[role="option"]:has-text("Facture")').first(),
    ).toBeVisible({ timeout: 3000 });
    await expect(
      page.locator('[role="option"]:has-text("Facture d\'acompte")'),
    ).toBeVisible();
    await expect(
      page.locator('[role="option"]:has-text("Facture de situation")'),
    ).toBeVisible();
    ...
    await expect(
      page.locator('label:has-text("Auto-liquidation")').first(),
    ).toBeVisible();
    ...
    await expect(
      page.locator('button:has-text("Créer la facture")').first(),
  ...
  test("Flow: Création facture d'acompte", async ({
    authenticatedPage: page,
  }) => {
    ...
    await typeSelect.click();
    await page
      .locator('[role="option"]:has-text("Facture d\'acompte")')
      .click();
