...
export function ProRouteGuard({
  ...
  const { isActive, isLoading, subscription, isInitialized } =
    useSubscription();
  ...
  // Skeleton désactivé - affichage direct du contenu
  // if (isLoading) {
  //   return (
  ...
  // Pendant la redirection, afficher le contenu directement
  return children;
}
