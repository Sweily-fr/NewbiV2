  ...
  const entries = [
    {
      ...
      description: 'Lancement du système de communauté permettant aux utilisateurs de proposer des idées, signaler des bugs et valider les fonctionnalités.',
      items: [
    ...
    },
    {
      ...
      description: 'Optimisation complète du système de cache pour le dashboard et les composants bancaires.',
      items: [
    ...
    },
    {
      ...
      description: 'Implémentation complète du système de parrainage avec bonus financier.',
      items: [
    ...
    },
    {
      ...
      description: 'Migration réussie vers la nouvelle architecture MongoDB avec amélioration de la sécurité.',
      items: [
              ...
              <div className="mx-auto max-w-3xl space-y-16 md:space-y-24">
                {entries.map((entry, index) => (
                  <div key={index} className="relative flex flex-col gap-4 md:flex-row md:gap-16">
                    <div className="top-8 flex h-min w-64 shrink-0 items-center gap-4 md:sticky">
                      <span className="text-sm font-medium text-primary">{entry.version}</span>
                ...
                <div className="relative flex flex-col items-center justify-center pt-16 pb-8 text-center">
                  <div className="relative mb-6">
                    <div className="absolute -inset-4 rounded-full bg-primary/10 dark:bg-primary/20"></div>
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-primary text-white">
                      <Rocket className="h-8 w-8" />
                    </div>
                  </div>
                  <h3 className="text-lg font-semibold text-foreground/90">Sortie de Newbi</h3>
                  <p className="mt-2 max-w-md text-sm text-muted-foreground">
                    Merci de faire partie de l'aventure Newbi. Restez à l'écoute pour les prochaines mises à jour !
                  </p>
                </div>
              </div>
            </div>
