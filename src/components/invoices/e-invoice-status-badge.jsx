...
const STATUS_CONFIG = {
  ...
  PARTIALLY_ACCEPTED: {
    ...
    description: "La facture a été acceptée partiellement par le destinataire",
  },
  DISPUTED: {
    label: "En litige",
    icon: AlertCircle,
    ...
    description: "La facture fait l'objet d'un litige (contestée)",
  },
  ON_HOLD: {
    label: "Suspendue",
    icon: Clock,
    ...
    description: "Le traitement de la facture est suspendu",
  },
  REFUSED: {
    label: "Refusée",
    icon: XCircle,
    ...
    description: "La facture a été refusée par le destinataire",
  },
  PAYMENT_SENT: {
    ...
    description: "Le paiement de la facture a été transmis",
  },
  REJECTED: {
    label: "Rejetée",
    icon: XCircle,
