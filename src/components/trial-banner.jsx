...
export function TrialBanner({ className, onStartTrial, onUpgrade }) {
  ...
  const bannerConfig = {
    ...
    active: {
      ...
      actionText: "Passer au premium",
      action: handleUpgrade,
    },
    expiring: {
      bgColor: "bg-blue-50 border-blue-200",
      textColor: "text-blue-900",
      icon: <Crown className="h-5 w-5 text-[#5B4FFF]" />,
      title: "Débloquez toutes les fonctionnalités",
      message: trial?.trialMessage || `Plus que ${trial?.daysRemaining || 0} jour(s) d'essai. Passez au premium pour continuer.`,
      actionText: "Passer au premium",
      action: handleUpgrade,
    },
    expired: {
      ...
      icon: <Crown className="h-5 w-5 text-[#5B4FFF]" />,
      title: "Débloquez toutes les fonctionnalités",
      message: "Votre période d'essai est terminée. Passez au premium pour continuer.",
      actionText: "Passer au premium",
      action: handleUpgrade,
    },
  };
