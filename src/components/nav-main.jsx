              ...
              <SidebarMenuButton
                ...
                className={cn(
                  ...
                  (pathname === "/dashboard/outils" ||
                    ...
                    "bg-[#5B4FFF]/90 text-primary-foreground hover:bg-[#5B4FFF]/90 hover:text-primary-foreground active:bg-[#5B4FFF]/90 active:text-primary-foreground min-w-8 duration-200 ease-linear"
                )}
