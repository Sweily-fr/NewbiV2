...
function CubeIcon() {
  return (
    <div className="relative shrink-0 w-10 h-10 rounded-lg border border-gray-200 overflow-hidden">
  ...
  return (
    <div className="flex flex-col h-full px-20 py-6">
      <div className="flex flex-col pt-14">
        ...
        <div className="inline-flex items-center self-start rounded-lg border border-[#EEEFF1] p-0.5 text-xs mb-6">
          <button
            type="button"
            onClick={() => setIsAnnual(true)}
            className={cn(
              "px-2.5 py-1 rounded-md cursor-pointer transition-colors flex items-center gap-1.5",
              isAnnual ? "bg-white font-medium shadow-sm" : "text-muted-foreground"
            )}
          >
            Annuel
              ...
              <div
                ...
                className={cn(
                  ...
                  isSelected
                    ...
                    : "border-gray-200 hover:border-[#d0d0d0]"
                )}
              >
                {plan.popular && (
                  <div className="mb-2">
