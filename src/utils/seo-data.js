...
export const seoData = {
  ...
  home: {
    ...
    openGraph: {
      ...
      description:
        "Gérez votre entreprise efficacement : facturation, devis, signatures, organisation. Plus de 200 entrepreneurs nous font confiance.",
    ...
    twitter: {
      ...
      title: "Newbi - La solution tout-en-un pour entrepreneurs",
      description:
        "Gérez votre entreprise efficacement : facturation, devis, signatures, organisation.",
      image: `/images/op-newbi.png`,
    },
    jsonLd: {
      ...
      description:
        "Solution de gestion complète pour entrepreneurs et freelances",
      foundingDate: "2023",
      address: {
        "@type": "PostalAddress",
        addressCountry: "FR",
  ...
  factures: {
    ...
    openGraph: {
      ...
      description:
        "Automatisez votre facturation et suivez vos paiements. Interface intuitive, conformité légale et gain de temps garanti.",
      image: `/images/op-newbi.png`,
      type: "website",
      locale: "fr_FR",
    },
    ...
    jsonLd: {
      ...
      operatingSystem: "Web",
      description:
        "Logiciel de facturation professionnel pour entrepreneurs et freelances",
  ...
  devis: {
    ...
    description:
      "Créez des devis professionnels personnalisés en quelques minutes. Conversion automatique en facture, suivi client et taux de conversion optimisé.",
    keywords:
      "créateur devis, devis professionnel, estimation, proposition commerciale, conversion facture, suivi client, devis en ligne, auto-entrepreneur",
    canonical: `${baseUrl}/produits/devis`,
    openGraph: {
      title: "Devis Professionnels en Ligne - Newbi",
      description:
        "Impressionnez vos clients avec des devis professionnels. Conversion facile en facture et suivi des acceptations.",
      image: `/images/op-newbi.png`,
      type: "website",
      locale: "fr_FR",
    },
  ...
  kanban: {
    ...
    openGraph: {
      ...
      description:
        "Boostez votre productivité avec nos tableaux Kanban. Organisation visuelle et collaboration simplifiée.",
      image: `/images/op-newbi.png`,
      type: "website",
      locale: "fr_FR",
    },
  ...
  transfers: {
    ...
    openGraph: {
      ...
      description:
        "Partagez vos fichiers professionnels en toute sécurité. Cryptage avancé et contrôle total sur vos partages.",
      image: `/images/op-newbi.png`,
      type: "website",
      locale: "fr_FR",
    },
    ...
    jsonLd: {
      ...
      operatingSystem: "Web",
      description:
        "Solution de transfert de fichiers sécurisé pour professionnels",
  ...
  login: {
    ...
    description:
      "Connectez-vous à votre compte Newbi pour accéder à tous vos outils de gestion d'entreprise : facturation, devis, signatures et plus.",
    keywords:
      "connexion newbi, login, espace client, compte utilisateur, authentification",
    robots: "noindex,nofollow",
    openGraph: {
      title: "Connexion à votre espace Newbi",
      description:
        "Accédez à votre tableau de bord et gérez votre entreprise efficacement.",
    },
  },
  ...
  signup: {
    ...
    description:
      "Créez votre compte Newbi gratuitement et accédez à tous nos outils de gestion d'entreprise. Essai gratuit sans engagement, activation immédiate.",
    keywords:
      "inscription newbi, créer compte, essai gratuit, registration, nouveau compte",
    openGraph: {
      title: "Créez votre compte Newbi gratuitement",
      description:
        "Rejoignez plus de 1000 entrepreneurs qui font confiance à Newbi. Inscription gratuite et activation immédiate.",
    },
    jsonLd: {
      "@context": "https://schema.org",
      "@type": "WebPage",
  ...
  mentionsLegales: {
    ...
    description:
      "Mentions légales, informations sur l'éditeur, hébergement et conditions d'utilisation de la plateforme Newbi.",
    keywords:
      "mentions légales, éditeur, hébergement, conditions utilisation, RGPD, données personnelles",
    robots: "index,nofollow",
    openGraph: {
      title: "Mentions Légales - Newbi",
      description:
        "Informations légales et réglementaires concernant l'utilisation de Newbi.",
    },
  },
  ...
  politiqueConfidentialite: {
    ...
    jsonLd: {
      ...
      description:
        "Politique de confidentialité et protection des données personnelles de Newbi",
  ...
  faq: {
    ...
    description:
      "Trouvez rapidement les réponses à vos questions sur Newbi : facturation, devis, signatures, tarifs, fonctionnalités. Support et aide complète.",
    keywords:
      "faq newbi, questions fréquentes, aide newbi, support client, guide utilisation, facturation aide, devis questions, tarifs newbi",
    canonical: `${baseUrl}/faq`,
    robots: "index,follow",
    openGraph: {
      title: "FAQ - Toutes vos questions sur Newbi",
      description:
        "Découvrez les réponses aux questions les plus fréquentes sur Newbi. Support complet et aide détaillée.",
      image: `/images/op-newbi.png`,
      type: "website",
      locale: "fr_FR",
    },
    twitter: {
      ...
      title: "FAQ - Toutes vos questions sur Newbi",
      description:
        "Découvrez les réponses aux questions les plus fréquentes sur Newbi.",
      image: `/images/op-newbi.png`,
    },
    jsonLd: {
      "@context": "https://schema.org",
      ...
      name: "FAQ Newbi",
      description:
        "Questions fréquentes et réponses sur l'utilisation de Newbi",
      url: `${baseUrl}/faq`,
      mainEntity: [
        {
          "@type": "Question",
  ...
  cgv: {
    ...
    description:
      "Consultez les conditions générales de vente de Newbi : modalités d'abonnement, facturation, résiliation, garanties et conditions d'utilisation.",
    keywords:
      "cgv newbi, conditions générales vente, modalités abonnement, facturation, résiliation, garanties, conditions utilisation",
    canonical: `${baseUrl}/cgv`,
    robots: "index,nofollow",
    openGraph: {
      title: "Conditions Générales de Vente - Newbi",
      description:
        "Découvrez les conditions générales de vente et d'utilisation de la plateforme Newbi.",
      image: `/images/op-newbi.png`,
      type: "website",
      locale: "fr_FR",
    },
    ...
    jsonLd: {
      ...
      description:
        "Conditions générales de vente et d'utilisation de la plateforme Newbi",
      url: `${baseUrl}/cgv`,
      isPartOf: {
        "@type": "WebSite",
        name: "Newbi",
...
export function generateMetaTags(pageKey, currentUrl = "") {
  ...
  return {
    ...
    twitter: {
      ...
      images: [
        seo.twitter?.image || seo.openGraph?.image || defaultSEO.defaultImage,
      ],
    },
...
/**
 * Fonction pour générer les metadata Next.js à partir des données SEO
 * @param {string} pageKey - Clé de la page dans seoData
 * @returns {Object} - Metadata Next.js
 */
export function generateNextMetadata(pageKey) {
  ...
  return {
    ...
    openGraph: {
      ...
      siteName: seoConfig.openGraph?.siteName || defaultSEO.siteName,
      images: seoConfig.openGraph?.image
        ...
        : [],
      locale: seoConfig.openGraph?.locale || defaultSEO.locale,
