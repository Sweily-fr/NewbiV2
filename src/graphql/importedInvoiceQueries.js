...
export const IMPORTED_INVOICE_STATUS_LABELS = {
  ...
  VALIDATED: "Terminée", // validée (importée = déjà émise, réputée réglée sauf preuve contraire)
  COMPLETED: "Terminée", // rattachée à une transaction (= COMPLETED côté Newbi)
  REJECTED: "Rejetée",
  ARCHIVED: "Archivée",
};
