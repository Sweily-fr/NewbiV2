...
export const DELETE_CLIENT_LISTS = gql`
  mutation DeleteClientLists($workspaceId: String!, $ids: [ID!]!) {
    deleteClientLists(workspaceId: $workspaceId, ids: $ids)
  }
`;

export const ADD_CLIENT_TO_LIST = gql`
  mutation AddClientToList(
    $workspaceId: String!
    $listId: ID!
    $clientId: ID!
  ) {
...
export const REMOVE_CLIENTS_FROM_LIST = gql`
  mutation RemoveClientsFromList(
    $workspaceId: String!
    $listId: ID!
    $clientIds: [ID!]!
  ) {
    removeClientsFromList(
      workspaceId: $workspaceId
      listId: $listId
      clientIds: $clientIds
    ) {
...
export const REMOVE_CLIENT_FROM_LISTS = gql`
  mutation RemoveClientFromLists(
    $workspaceId: String!
    $clientId: ID!
    $listIds: [ID!]!
  ) {
    removeClientFromLists(
      workspaceId: $workspaceId
      clientId: $clientId
      listIds: $listIds
    ) {
