// Template pour rappel de renouvellement - Style Qonto
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 0 20px; background-color: #fafafa;">
        ...
        <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 32px 24px; margin-bottom: 32px;">
          ...
          <h1 style="font-size: 26px; font-weight: 500; color: #1a1a1a; margin: 0 0 24px 0; line-height: 1.3;">
            Votre abonnement sera renouvelé dans 7 jours
          </h1>
          ...
          <p style="font-size: 15px; color: #4b5563; margin: 0 0 24px 0; line-height: 1.6;">
            Votre abonnement au plan <strong style="color: #1a1a1a;">${plan}</strong> sera automatiquement renouvelé le <strong style="color: #1a1a1a;">${renewalDate}</strong>.
          </p>
          ...
          <div style="background-color: #fafafa; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                <td style="padding: 6px 0; font-size: 14px; color: #6b7280;">Date de renouvellement</td>
                <td style="padding: 6px 0; font-size: 14px; color: #1a1a1a; text-align: right;">${renewalDate}</td>
              </tr>
              <tr style="border-top: 1px solid #e5e7eb;">
                <td style="padding: 12px 0 6px 0; font-size: 14px; color: #6b7280; font-weight: 500;">Montant</td>
                <td style="padding: 12px 0 6px 0; font-size: 16px; color: #1a1a1a; font-weight: 600; text-align: right;">${amount}</td>
              </tr>
            </table>
          </div>
        ...
        <div style="border-top: 1px solid #e5e7eb; padding-top: 32px; text-align: center;">
          ...
          <p style="font-size: 12px; color: #9ca3af; margin: 0 0 24px 0; line-height: 1.8;">
            Le paiement sera prélevé automatiquement. Vous pouvez modifier ou annuler à tout moment. • <a href="https://newbi.fr/aide" style="color: #9ca3af; text-decoration: underline;">FAQ</a>
          </p>
