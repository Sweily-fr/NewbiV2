// Template pour nouvel abonnement - Style Qonto
export const subscriptionCreated = ({
  ...
  billingInterval,
    ...
    <head>
      ...
      <title>Votre abonnement est activé</title>
    </head>
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 0 20px; background-color: #fafafa;">
        ...
        <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 32px 24px; margin-bottom: 32px;">
          ...
          <p style="font-size: 15px; color: #4b5563; margin: 0 0 24px 0; line-height: 1.6;">
            Votre abonnement au plan <strong style="color: #1a1a1a;">${plan}</strong> a été activé avec succès. Vous bénéficiez désormais de l'ensemble des fonctionnalités pour gérer votre activité en toute simplicité.
          </p>
