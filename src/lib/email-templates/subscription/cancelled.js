// Template pour annulation d'abonnement - Style Qonto
export const subscriptionCancelled = ({ customerName, plan, endDate }) => `
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 0 20px; background-color: #fafafa;">
        ...
        <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 32px 24px; margin-bottom: 32px;">
          ...
          <p style="font-size: 15px; color: #4b5563; margin: 0 0 24px 0; line-height: 1.6;">
            Votre abonnement au plan <strong style="color: #1a1a1a;">${plan}</strong> a bien été résilié. Vous conservez l'accès à toutes les fonctionnalités jusqu'au <strong style="color: #1a1a1a;">${endDate}</strong>.
          </p>
          
          <!-- Info box -->
          <div style="background-color: #fafafa; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
            <p style="font-size: 13px; color: #6b7280; margin: 0; line-height: 1.6;">
              • Aucun nouveau prélèvement ne sera effectué<br>
              • Vos données seront conservées 30 jours<br>
        ...
        <div style="border-top: 1px solid #e5e7eb; padding-top: 32px; text-align: center;">
          ...
          <p style="font-size: 12px; color: #9ca3af; margin: 0 0 24px 0; line-height: 1.8;">
            Nous sommes désolés de vous voir partir. Une question ? • <a href="https://newbi.fr/aide" style="color: #9ca3af; text-decoration: underline;">FAQ</a>
          </p>
