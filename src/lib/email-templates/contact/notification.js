...
export const contactNotification = ({
  ...
  return `
    ...
    <head>
      ...
      <title>Message de contact - ${safeName}</title>
    </head>
        ...
        <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 32px 24px; margin-bottom: 32px;">
          ...
          <div style="margin-bottom: 20px;">
            <div style="display: inline-flex; align-items: center; background-color: #f3f4f6; border-radius: 6px; padding: 8px 12px;">
              <span style="font-size: 11px; font-weight: 500; color: #374151; letter-spacing: 0.3px; text-transform: uppercase;">FORMULAIRE DE CONTACT</span>
            </div>
          </div>
          ...
          <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
              <tr>
                ...
                <td style="font-size: 13px; color: #1a1a1a; padding: 10px 0; text-align: right; font-weight: 500; border-bottom: 1px solid #e5e7eb;">${safeName}</td>
              </tr>
              <tr>
                <td style="font-size: 13px; color: #6b7280; padding: 10px 0;">Email</td>
                <td style="font-size: 13px; padding: 10px 0; text-align: right; font-weight: 500;"><a href="mailto:${safeEmail}" style="color: #5B4FFF; text-decoration: none;">${safeEmail}</a></td>
              </tr>
            </table>
          </div>

          <!-- Message -->
          <p style="font-size: 15px; color: #4b5563; margin: 0; line-height: 1.6; white-space: pre-line;">
            ${safeMessage}
          </p>
        </div>
