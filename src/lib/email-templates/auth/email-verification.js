// Template pour la vérification d'email - Style Qonto
export const emailVerification = (url) => `
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 0 20px; background-color: #fafafa;">
        ...
        <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 32px 24px; margin-bottom: 32px;">
          ...
          <div style="margin-bottom: 20px;">
            <div style="display: inline-flex; align-items: center; background-color: #f3f4f6; border-radius: 6px; padding: 8px 12px;">
              ...
              <span style="font-size: 11px; font-weight: 500; color: #374151; letter-spacing: 0.3px; text-transform: uppercase;">E-MAIL</span>
            </div>
          </div>
          ...
          <p style="font-size: 15px; color: #4b5563; margin: 0 0 24px 0; line-height: 1.6;">
            Bienvenue sur Newbi ! Pour finaliser votre inscription et accéder à votre espace, veuillez confirmer votre adresse e-mail.
          </p>
        ...
        <div style="border-top: 1px solid #e5e7eb; padding-top: 32px; text-align: center;">
          ...
          <p style="font-size: 12px; color: #9ca3af; margin: 0 0 24px 0; line-height: 1.8;">
            Ce lien expire dans 1 heure. Si vous n'avez pas créé de compte, ignorez cet e-mail. • <a href="https://newbi.fr/aide" style="color: #9ca3af; text-decoration: underline;">FAQ</a>
          </p>
