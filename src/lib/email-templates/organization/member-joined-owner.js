// Template pour notifier l'owner qu'un membre a rejoint - Style Qonto
export const memberJoinedNotificationOwner = (data) => `
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
                    ...
                    <tr>
                      <td style="vertical-align: middle; padding-right: 12px;">
                        <div style="
                          ...
                          font-weight: 600;
                          font-size: 12px;
                        ">${(data.member.user.name || data.member.user.email).charAt(0).toUpperCase()}</div>
                      </td>
                      <td style="vertical-align: middle;">
      ...
      Gérer les membres
        ...
        <div style="border-top: 1px solid #e5e7eb; padding-top: 32px; text-align: center; margin-top: 48px;">
          ...
          <p style="font-size: 12px; color: #9ca3af; margin: 0 0 24px 0; line-height: 1.8;">
            Vous pouvez gérer les membres de votre organisation depuis les paramètres. • <a href="https://newbi.fr/aide" style="color: #9ca3af; text-decoration: underline;">FAQ</a>
          </p>
