// Template pour notifier l'inviter qu'un membre a rejoint - Style Qonto
export const memberJoinedNotificationInviter = (data) => `
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
      ...
      Accéder à mon espace
        ...
        <div style="border-top: 1px solid #e5e7eb; padding-top: 32px; text-align: center; margin-top: 48px;">
          ...
          <p style="font-size: 12px; color: #9ca3af; margin: 0 0 24px 0; line-height: 1.8;">
            Vous pouvez maintenant travailler ensemble sur vos projets. • <a href="https://newbi.fr/aide" style="color: #9ca3af; text-decoration: underline;">FAQ</a>
          </p>
