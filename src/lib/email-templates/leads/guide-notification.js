export const guideLeadNotification = ({
  firstName = "Jean",
  lastName = "Dupont",
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 0 20px; background-color: #fafafa;">
        ...
        <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 32px 24px; margin-bottom: 32px;">
          ...
          <p style="font-size: 15px; color: #4b5563; margin: 0 0 24px 0; line-height: 1.6;">
            Un nouveau prospect a t\u00e9l\u00e9charg\u00e9 le <strong>${guideName}</strong> depuis le site et a \u00e9t\u00e9 ajout\u00e9 au CRM.
          </p>
          ...
          <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
              <tr>
                <td style="font-size: 13px; color: #6b7280; padding: 10px 0; border-bottom: 1px solid #e5e7eb;">Pr\u00e9nom</td>
              ...
              <tr>
                <td style="font-size: 13px; color: #6b7280; padding: 10px 0; border-bottom: 1px solid #e5e7eb;">T\u00e9l\u00e9phone</td>
        ...
        <div style="border-top: 1px solid #e5e7eb; padding-top: 32px; text-align: center;">
          ...
          <p style="font-size: 12px; color: #9ca3af; margin: 0 0 24px 0; line-height: 1.8;">
            Notification automatique. Ne r\u00e9pondez pas directement \u00e0 cet email.
          </p>
