// Template pour paiement réussi - Style Qonto
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 0 20px; background-color: #fafafa;">
        ...
        <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 32px 24px; margin-bottom: 32px;">
          ...
          <p style="font-size: 15px; color: #4b5563; margin: 0 0 24px 0; line-height: 1.6;">
            Merci pour votre paiement ! Votre abonnement au plan <strong style="color: #1a1a1a;">${plan}</strong> est actif.
          </p>
          ...
          <div style="background-color: #fafafa; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                ...
                <td style="padding: 6px 0; font-size: 14px; color: #1a1a1a; text-align: right;">${invoiceNumber}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="padding: 6px 0; font-size: 14px; color: #6b7280;">Prochain renouvellement</td>
                <td style="padding: 6px 0; font-size: 14px; color: #1a1a1a; text-align: right;">${nextRenewalDate}</td>
              </tr>
              <tr style="border-top: 1px solid #e5e7eb;">
                <td style="padding: 12px 0 6px 0; font-size: 14px; color: #6b7280; font-weight: 500;">Montant payé</td>
                <td style="padding: 12px 0 6px 0; font-size: 16px; color: #10b981; font-weight: 600; text-align: right;">${amount}</td>
              </tr>
            </table>
          </div>
