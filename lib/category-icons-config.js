...
/**
 * Catégories larges de dépense (enum ExpenseCategory du modèle Transaction
 * côté API). Les transactions bancaires catégorisées automatiquement ou
 * anciennes n'ont souvent que cette catégorie large, sans sous-catégorie fine.
 */
export const EXPENSE_BROAD_CATEGORY_CODES = [
  "OFFICE_SUPPLIES",
  "TRAVEL",
  "MEALS",
  "ACCOMMODATION",
