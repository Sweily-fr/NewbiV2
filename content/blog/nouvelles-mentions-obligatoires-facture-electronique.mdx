...
description: >-
  ...
  les débits : les nouvelles mentions imposées par la réforme de la facturation
  électronique.
date: '2026-09-07'
...
Parmi ces mentions classiques, le taux des pénalités de retard et l'indemnité forfaitaire de 40 € pour frais de recouvrement restent exigés sur chaque facture entre professionnels : [le calcul de ces pénalités et la mention à recopier sur la facture](/blog/penalites-retard-indemnite-forfaitaire-40-euros) ne changent pas avec le passage au format structuré.
